    ...
    def update_dr_param(self, param, param_name, eps=1e-3, indices=None, max_val=float('inf')):
        if param_name in self.dr:
            ...
            if 'rope_len' in param_name: #clip rope length
                ...
                new_value = np.clip(new_value, a_min=rope_len_min + eps, a_max=16.)
    ...
    def apply_dr(self, set_real=False):
        ...
        if 'rope' in self.task:
            ...
            dr_update_dict = {
                ...
                'box1_r': (model.geom_rgba[:, 0], [box_viz_1, box_viz_2, box_viz_3, box_viz_4, box_viz_5]),
                'box1_g': (model.geom_rgba[:, 1],  [box_viz_1, box_viz_2, box_viz_3, box_viz_4, box_viz_5]),
                'box1_b': (model.geom_rgba[:, 2],  [box_viz_1, box_viz_2, box_viz_3, box_viz_4, box_viz_5]),
