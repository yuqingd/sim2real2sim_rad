...
from environments.kitchen.adept_envs.adept_envs import mujoco_env
from environments.kitchen.adept_envs.adept_envs.base_robot import BaseRobot
from environments.kitchen.adept_envs.adept_envs.utils.configurable import import_class_from_path
from environments.kitchen.adept_envs.adept_envs.utils.constants import MODELS_PATH
...
class RobotEnv(mujoco_env.MujocoEnv):
    ...
    def __init__(self,
        ...
        try:
            from environments.kitchen.adept_envs.adept_envs.utils.remote_viz import RemoteViz
